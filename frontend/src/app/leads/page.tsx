...
//     switch (outcome) {
//       case "booked_trial": return "#059669"
//       case "callback_requested": return "#d97706"
//       case "not_interested": return "#dc2626"
...
//   return (
//     <main style={{ maxWidth: 1100, margin: "0 auto", padding: "40px 20px", fontFamily: "sans-serif" }}>
      
//       {/* Header */}
//       <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 32 }}>
//         <div>
//           <h1 style={{ fontSize: 28, fontWeight: "bold", margin: 0 }}>Blueslate</h1>
//           <p style={{ color: "#6b7280", margin: "4px 0 0" }}>XP League Frisco — Leads Dashboard</p>
//         </div>
...
//           { label: "Booked Trial", value: leads.filter(l => l.call_outcome === "booked_trial").length },
//           { label: "Callback Requested", value: leads.filter(l => l.call_outcome === "callback_requested").length },
//           { label: "General Inquiry", value: leads.filter(l => l.call_outcome === "general_inquiry").length },
//         ].map(({ label, value }) => (
//           <div key={label} style={{
//             flex: 1,
//             padding: 16,
...
//           }}>
//             <p style={{ fontSize: 13, color: "#6b7280", margin: "0 0 4px" }}>{label}</p>
...
//                       background: `${getOutcomeColor(lead.call_outcome)}15`,
//                       padding: "3px 8px",
//                       borderRadius: 4
//                     }}>
...
//                 Call Transcript — {selectedLead.caller_name}
//               </h2>
//               <button
